...
The **Insurgent's Handbook** is a community resource created to serve as a reference manual for Final Fantasy XII modding. 
...
Whether you are editing dialogues or completely redesigning a map, the Handbook holds the vital data you will need:

- **Map EBP Scripts:** Detailed breakdowns of how the Environment Blueprint Packs (EBP) work, mapping out logic, NPCs, and event triggers.
- **Text Tags:** The game uses special text tags (like `<color>`, `<icon>`, or `<var>`) for dialogue and UI formatting. The Handbook provides a complete list of these tags so you can format your custom text perfectly.
