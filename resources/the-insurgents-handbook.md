...
- **Text Tags:** The game uses special text tags (like `{color:x}`, `{icon:x}`, or `{wait}`) for dialogue and UI formatting. The Insurgent's Handbook provides a complete list of these tags so you can format your custom text perfectly.
