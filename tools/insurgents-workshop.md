...
Once the data is in a readable format, you can open it in any text editor, make your desired changes (like editing stats, names, or values), and then use the Workshop to compile (pack) it back into the original binary format that the game expects.
