...
**The Insurgent's Toolkit** is a real-time memory editor and modding suite for _Final Fantasy XII: The Zodiac Age_.

For serious modding, this tool is invaluable. It acts as a bridge between the game's live memory and your ideas. Through The Insurgent's Toolkit, you can modify the game in real-time, understand exactly how certain data structures are read from memory, and obtain static and dynamic addresses to use in your **FF12 Lua Loader** mods.
...
The Toolkit touches almost every system in the game. Here is a brief summary of what you can accomplish with it:
...
- **Game State Control:** Manipulate the RNG, chain levels, magick fields, FOV (field of view), no-clip (move through walls), and general post-processing, UI, or Game Settings (resolution, VSync, anti-aliasing, shadows, frame rate limit, and more).
...
{% hint style="success" %}
**Download & Setup**
Because The Insurgent's Toolkit is so extensive, it comes with its own detailed wiki. We highly recommend reading through it to understand how to properly set it up and utilize all of its features.
